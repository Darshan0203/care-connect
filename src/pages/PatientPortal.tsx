...
const PatientPortal = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success(isLogin ? "Login successful!" : "Account created successfully!", {
      description: isLogin ? "Redirecting to dashboard..." : "Please check your email to verify your account.",
    });
  };
          ...
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {isLogin
                ...
                : "Join MedCare for personalized healthcare"}
            </CardDescription>
          </CardHeader>
          <CardContent>
